...
function dTree(objName, objbool) {        // void ���췽��������������objName: �����ơ�objbool����ѡ��ѡ true��ѡ  false��ѡ  Ĭ�ϵ�ѡ         
    ...
    this.icon = {
        root:        '/acms/img/base.gif',         // Node ���ڵ㡣 
        folder:      '/acms/img/folder.gif',       // Node ���ڵ㡣 
        folderOpen:  '/acms/img/folderopen.gif',   // �򿪵��ļ���,Ĭ��'/acms/img/folderOpen.gif' 
        node:        '/acms/img/page.gif',         // �򿪵��ļ���,Ĭ��'/acms/img/folderOpen.gif' 
        empty:       '/acms/img/empty.gif',        // �򿪵��ļ���,Ĭ��'/acms/img/folderOpen.gif' 
        line:        '/acms/img/line.gif',         // ����,Ĭ��'/acms/img/line.gif'
        join:        '/acms/img/join.gif',         // ����,Ĭ��'/acms/img/join.gif' 
        joinBottom:  '/acms/img/joinbottom.gif',   // ֱ����,Ĭ��'/acms/img/joinbottom.gif' 
        plus:        '/acms/img/plus.gif',         // �ӺŶ���,Ĭ��'/acms/img/plus.gif' 
        plusBottom:  '/acms/img/plusbottom.gif',   // �Ӻ�ֱ����,Ĭ��'/acms/img/plusbottom.gif' 
        minus:       '/acms/img/minus.gif',        // ���Ŷ���,Ĭ��'/acms/img/minus.gif' 
        minusBottom: '/acms/img/minusbottom.gif',  // ����ֱ����,Ĭ��'/acms/img/minusbottom.gif'  
        nlPlus:      '/acms/img/nolines_plus.gif', // ����ֱ����,Ĭ��'/acms/img/minusbottom.gif' 
        nlMinus:     '/acms/img/nolines_minus.gif' //���߼���,Ĭ��'/acms/img/nolines_minus.gif' 
    };
